...
public class MouseMover {
   ...
   public void moveComplicated(int xe, int ye){
    ...
    public void moveDistance(int deltaX, int deltaY){
        robot.mouseMove(a.getLocation().x+deltaX, a.getLocation().y+deltaY);
    }
